...
## Controle virtual na SessionScreen
- D-pad: `up/down/left/right`
- Botões: `A/B/X/Y`, `L/R`, `Start/Select`
- Multitouch: possível pressionar múltiplos botões ao mesmo tempo
- Ajustes rápidos: opacidade e tamanho dentro da SessionScreen
- Base pronta para modo analógico (`mode: analog-ready` no store de gamepad)
